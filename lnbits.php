        ...
        public function init_form_fields() {
            ...
            $this->form_fields = array(
                ...
                'lnbits_api_key' => array(
                    ...
                    'type' => 'text',
                    'description' => __('Your personal API Key. Generate one <a href="https://legend.lnbits.com" target="_blank">here</a>. You can find it in your LNBits wallet under API info -> "Invoice/read key".', 'woocommerce'),
                    'default' => '',
                ),
                'lnbits_url' => array(
