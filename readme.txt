...
= OpenNode API =
This plugin uses opennode.co API for converting fiat currencies into Bitcoin, according to the current rates.
https://developers.opennode.com/reference/exchange-rates
